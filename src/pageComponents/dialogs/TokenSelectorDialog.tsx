...
import { BRRRMint, USDCMint, USDTMint } from '@/application/token/wellknownToken.config'
        ...
        <>
          <div className="px-8 mobile:px-6 pt-6 pb-5">
            ...
            <Row className="justify-between">
              {([BRRRMint, QuantumSOLVersionSOL, USDTMint, USDCMint] as const).map((mintish, idx) => {
